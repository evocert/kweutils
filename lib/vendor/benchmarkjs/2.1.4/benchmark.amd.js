 ...
 */
define(["module","lodash","platform"],function(module,_,platform){//skullquake
...
;(function() {
  ...
  function runInContext(context) {
	...
	var Object={};//skullquake - goja???
    /** Used for `Array` and `Object` method references. */
    var arrayRef = [],
        //objectProto = Object.prototype;
        objectProto = Object.prototype;

	  var Math=_Math;//skullquake
    ...
    var abs = Math.abs,
        ...
        sqrt = Math.sqrt,
        toString = JSON.stringify,//skullquake objectProto.toString,
  ...
  if (typeof module == 'object' && typeof module.exports == 'object'){//skullquake
	var self=global;//skullquake
	var Benchmark = runInContext(self);//skullquake
