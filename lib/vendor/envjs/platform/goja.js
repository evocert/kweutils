define([],function(){
	...
	//var Envjs = Envjs || 
		...
		//require('local_settings');//skullquake

	Envjs.platform       = "Goja";
	//Envjs.revision       = process.version;//skullquake
	...
	var $print = console.log;//require('sys').print;
	...
	//var Script = process.binding('evals').Script;//skullquake
	...
	Envjs.onExit = function(callback){
	    //process.on('exit', callback);//skullquake
	};
	...
	//Envjs.homedir        = process.env["HOME"];//skullquake
	//Envjs.tmpdir         = process.env["TMPDIR"];//skullquake
	//Envjs.os_name        = process.platform;//skullquake
	Envjs.os_arch        = "os arch";
	Envjs.os_version     = "os version";
	//Envjs.lang           = process.env["LANG"];//skullquake
