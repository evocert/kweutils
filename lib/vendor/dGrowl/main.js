		...
		packages:[
			{
				...
				location:'/widgets/MxdGrowl/lib/dGrowl/',
				main:'NotificationNode'
			}
		]
	},
	[
		...
		"dojo/topic",
		"dojo/dom-construct",
		//"dGrowl/NotificationNode",
		"NotificationNode",
		"dojo/query",
		"dojo/dom-class"
	],
	function(t, declare, base, templated, topic, domCon, NotificationNode, query, domClass)
{
	...
	{
		'templateString':'<div id="${id}" class="dGrowl-main"><ul data-dojo-attach-point="channelsN"></ul></div>',
		...
		'postCreate':function()
		{
			...
			// event
			this._s = topic.subscribe('dGrowl', dojo.hitch(this, this._subscribedChannels));
			// style myself..
