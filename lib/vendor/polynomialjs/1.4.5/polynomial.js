...
define(["module","fraction","complex","quaternion"],function(module,Fraction,Complex,Quaterion) {
(function(root) {
  ...
  Polynomial['fromRoots'] = function(roots) {
    ...
    var nonZeroRoots = roots.filter(
	    function(root){return(!(FIELD['equals'](root, zero)))}
    );
  ...
  if (typeof module === 'object') {
	  /*/skullquake*
	    define(["fraction", "complex", "quaternion"], function(frac, comp, quat) {
	      Fraction = frac;
	      Complex = comp;
	      Quaternion = quat;
	      return Polynomial;
