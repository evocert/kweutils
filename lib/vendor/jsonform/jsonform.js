...
jsonform.elementTypes = {
  ...
  'textarea':{
    'template':'<textarea id="<%= id %>" name="<%= node.name %>" ' +
      '<%= (fieldHtmlClass ? "class=\'" + fieldHtmlClass + "\' " : "class=\'form-control\' ") %>' +
  ...
  'ace':{
    ...
    'onInsert': function (evt, node) {
      var setup = function () {
        ...
        if(typeof(formElement.preinit)=='function'){//sq2020 Wed Sep 16 09:11:01 SAST 2020
		formElement.preinit.bind(this)(node);//.bind(this)(this);
	}
        var ace = window.ace;
        ...
        if(typeof(formElement.postinit)=='function'){//sq2020 Wed Sep 16 09:11:01 SAST 2020
		formElement.postinit.bind(this)(editor,node);
	}
      }

      // Is there a setup hook?
      if (window.jsonform_ace_setup) {//sq2020 Wed Sep 16 09:57:39 SAST 2020 compare with postinit preinit
...
$.fn.jsonForm = function(options) {
  ...
  if (options.submitEvent) {//sq2020 Wed Sep 16 10:00:51 SAST 2020 - may interfere with ace editor enter keydown
