define([
	...
	.then(function(val){console.log(val);return fm.rm("./test");})
	.then(function(val){console.log(val);return fm.bulk([
		{"cmd":"ls","args":{"path":"/tmp"}},
		{"cmd":"ls","args":{"path":"/usr/share/man/man1"}},
		{"cmd":"ls","args":{"path":"/usr/share/man/man2"}}
	]);})
